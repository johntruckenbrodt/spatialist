# -*- coding: utf-8 -*-
#
# spatialist documentation build configuration file, created by
...
htmlhelp_basename = 'spatialistdoc'
...
latex_documents = [
    ('index', 'spatialist.tex', u'spatialist Documentation',
...
man_pages = [
    ('index', 'spatialist', u'spatialist Documentation',
...
texinfo_documents = [
    ('index', 'spatialist', u'spatialist Documentation',
     u'John Truckenbrodt, Felix Cremer, Ismail Baris', 'spatialist', 'One line description of project.',
     'Miscellaneous'),
]
